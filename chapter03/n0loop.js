...
// 이상의 코드에서 필요한 것은 (Java에서도 말함) 향상된 for문의 작성 때문에 배열처럼 다수의 데이털ㄹ 다루는 collections에 해당하는 자료형은 변수명을 복수형으로 짓는 편

// for (const name of names) 로 쓸 때 영어상 읽기가 훨씬 편하기 때문
