...
// let darkModeOn = true;
// const PI = 3.14159;
// index.html 생성 -> 개발자 도구를 통해서 콘솔 확인 가능

// let a = 1;
// console.log(a);
// a = 2;  // java 에서 처음 선언 및 초기호 하는 것과 재대입 상에서의 차이를 생각
// console.log(a);
// // 변수 b를 a에 대입하는 방식
// let b = a;
// console.log(a, b); // 결과값 : 2 2 : 콤마(,)는 출력되지 않는 점에 주목

// Java와의 차이점
// a = "안녕하세요";   // 2인 a에 string 값 대입
// b = true;          // 2인 b에 boolean 값 대입
// console.log(a, b);
// 이상의 코드에서 자바스크립트 / 파이썬에서는 데이터의 종류를 구분하는 데 있어 타 언어만큼 언격한 기준이 있지 않음.
...
// 오류 발생 사례
// A = 10;
// n0hellojs.js:32 Uncaught TypeError: Assignment to constant variable.

// let c = 10; -> 동일한 변수를 두 번 선언했기 때문
// let c = 12;
// Uncaught SyntaxError: Identifier 'c' has already been declared (at n0hellojs.js:36:5)
...
// 이상의 코드에서 알 수 있는 점은 조건식에 자주 사용되고, 비교 연산의 결과값을 산출할 때 많이 사용됨.
...
// console.log(typeof str02);  // string
...
// 문자열의 경우에 알파벡 순서상 뒤에 오는 것을 더 크다고 판단
...
// # 2 Java에서의 Map 자료형과 같은 받식이라는 점ㅇ에서
console.log(person01["name"]);
