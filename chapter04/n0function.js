...
// call1() 유형인 경우 sumTo(5)로 작성하니까 바로 브라우저에서 결과값이 나온 반면, call4()유형으로 작성한 add의 경우 console.log() 명령어를 작성해야만 함.
// add() 함수의 경우 내부에 console.log() 실행문이 없기 때문에 concole.log(add(2,3))

// console.log(add(2,3));

// console.log(
//   add(add(6,7), add(8,9)) // 길어지는 경우 가독성을 위해 엔터
// );
// 이상의 코드는 함수를 3번 호출
// add(6,7)을 연산하여 결과값을 argument 1번으로,
// add(8,9)를 연산하여 경과값을 argument 2번으로 하여
